  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 md:px-8 space-y-8 pb-16 py-4">
      ...
      <div className="enamo-card p-8 md:p-12 text-center space-y-4 bg-slate-950 text-white relative overflow-hidden">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight">Vision & Mission</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="enamo-card p-8 space-y-4">
          <div className="w-12 h-12 rounded-full bg-slate-900 text-white flex items-center justify-center font-bold">
            <BookOpen size={22} />
          </div>
          <h2 className="text-xl font-extrabold text-slate-950">Free Primary Education</h2>
        ...
        <div className="enamo-card p-8 space-y-4">
          ...
          <h2 className="text-xl font-extrabold text-slate-950">Animal Welfare & Rescue</h2>
          <p className="text-slate-600 text-xs md:text-sm leading-relaxed">
        ...
        <div className="enamo-card p-8 space-y-4">
          ...
          <h2 className="text-xl font-extrabold text-slate-950">Student Empowerment</h2>
          <p className="text-slate-600 text-xs md:text-sm leading-relaxed">
      ...
      {/* Objectives Section */}
      <div className="enamo-card p-8 md:p-12 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        <div className="md:col-span-7 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-100 rounded-full text-xs font-bold text-slate-900">
            <Target size={14} />
