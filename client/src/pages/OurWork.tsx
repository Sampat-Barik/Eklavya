...
export const OurWork: React.FC = () => {
  return (
    <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-16 sm:space-y-24">
          ...
          <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3 lg:items-end">
            <div className="bg-slate-50 border border-slate-900/[0.08] rounded-xl p-4 w-full sm:w-auto lg:w-full space-y-2">
              ...
              <div className="flex items-center justify-between text-xs font-mono text-slate-600">
                ...
                <span className="font-bold text-blue-700">120+ ANNUAL</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-slate-900/[0.08] pt-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl border border-slate-900/[0.08] bg-white space-y-3 shadow-2xs">
