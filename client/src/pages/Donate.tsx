    ...
    <div className="max-w-[1720px] 2xl:max-w-[1800px] w-full mx-auto px-6 sm:px-10 lg:px-16 py-10 sm:py-16 space-y-16 sm:space-y-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="p-4 rounded-xl border border-slate-200 bg-white/90 backdrop-blur-md space-y-1 shadow-xs">
                <span className="font-serif text-lg font-extrabold text-slate-900">₹250</span>
                <span className="block text-xs font-bold text-slate-900">1 Student Term Kit</span>
                <p className="text-[11px] text-slate-600">Notebooks, pencils, eraser, and daily snacks for 1 month.</p>
              </div>
              <div className="p-4 rounded-xl border border-slate-200 bg-white/90 backdrop-blur-md space-y-1 shadow-xs">
                <span className="font-serif text-lg font-extrabold text-slate-900">₹650</span>
                <span className="block text-xs font-bold text-slate-900">Vaccine & De-worming</span>
                <p className="text-[11px] text-slate-600">Anti-rabies vial and 14-day anti-parasite medication.</p>
              </div>
              <div className="p-4 rounded-xl border border-slate-200 bg-white/90 backdrop-blur-md space-y-1 shadow-xs">
                <span className="font-serif text-lg font-extrabold text-slate-900">₹1,800</span>
                <span className="block text-xs font-bold text-slate-900">Emergency Surgery</span>
          ...
          <div className="bg-white/90 backdrop-blur-md border border-slate-200 rounded-2xl p-6 sm:p-10 space-y-6 shadow-md">
            ...
            {submittedSuccess ? (
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-8 text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-700 max-w-sm mx-auto mt-1 leading-relaxed font-normal">
                ...
                <button
                  ...
                  className="font-mono text-xs font-bold text-slate-900 bg-white border border-slate-200 hover:bg-slate-50 px-5 py-2.5 rounded-lg transition-colors inline-block cursor-pointer shadow-xs"
                >
              ...
              <form onSubmit={handleSubmitProof} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block font-mono text-[11px] uppercase tracking-wider text-slate-800 font-bold mb-1.5">
                      Full Name *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3.5 py-2.5 text-xs font-medium text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 transition-colors"
                    />
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3.5 py-2.5 text-xs font-mono font-medium text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative border border-slate-300 border-dashed rounded-xl p-5 bg-slate-50 text-center hover:bg-white transition-colors cursor-pointer">
                    <input
                      type="file"
                      accept="image/*"
                      required
                    ...
                    />
                    <Upload size={20} className="mx-auto text-blue-600 mb-1" strokeWidth={1.75} />
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-3.5 bg-gradient-to-r from-blue-600 via-cyan-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 text-white font-mono text-xs uppercase tracking-wider font-semibold rounded-xl shadow-md flex items-center justify-center gap-2 transition-all pt-3 cursor-pointer"
                >
                  <Send size={14} />
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white/90 backdrop-blur-md border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-6 shadow-md">
            <div className="flex items-center justify-between border-b border-slate-200 pb-4">
              <div className="flex items-center gap-2">
                <QrCode size={18} className="text-blue-600" />
                <span className="font-serif font-bold text-base text-slate-900">Instant UPI Payment</span>
              </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 text-center space-y-3">
              <div className="w-44 h-44 mx-auto bg-white border border-slate-200 rounded-lg p-3 shadow-xs flex flex-col items-center justify-center">
              ...
              <div className="space-y-0.5 pt-1">
                ...
                <span className="text-[11px] text-slate-600 font-medium block">{currentTitle}</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-2.5 bg-slate-50 hover:bg-slate-100 text-slate-900 border border-slate-200 rounded-xl text-xs font-mono uppercase tracking-wider font-semibold flex items-center justify-center gap-2 transition-colors cursor-pointer shadow-xs"
            >
              <RefreshCw size={13} />
            ...
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 flex items-center justify-between gap-3">
              ...
              <button
                ...
                className="shrink-0 flex items-center gap-1 text-xs bg-blue-600 hover:bg-blue-700 text-white font-mono px-3 py-1.5 rounded-lg transition-colors font-semibold cursor-pointer shadow-xs"
              >
                {copiedUPI ? <CheckCircle2 size={13} className="text-white" /> : <Copy size={13} />}
            ...
            <div className="pt-2 text-center text-xs text-slate-600 space-y-1">
              ...
              <p className="font-mono text-[10px] text-slate-500 font-semibold">HIT STUDENTS SOCIO-WELFARE ACCOUNT</p>
            </div>
          </div>
        </div>
      </div>
